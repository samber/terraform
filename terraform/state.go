...
func upgradeV1State(old *StateV1) (*State, error) {
	...
	// "lineage" was not a concept in V1, so empty out the new lineage
	// that s.init() just placed there or else different upgraders
	// of the same state will end up with non-compatible lineages.
	s.Lineage = ""
